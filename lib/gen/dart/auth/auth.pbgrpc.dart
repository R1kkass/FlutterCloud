...
class AuthGreetClient extends $grpc.Client {
  ...
  static final _$refresh = $grpc.ClientMethod<$0.RefreshRequest, $0.RefreshResponse>(
      '/auth.AuthGreet/Refresh',
      ($0.RefreshRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.RefreshResponse.fromBuffer(value));
  ...
  static final _$submitEmail = $grpc.ClientMethod<$0.SubmitEmailRequest, $0.SubmitEmailResponse>(
...
abstract class AuthGreetServiceBase extends $grpc.Service {
  ...
  AuthGreetServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.Empty, $0.Empty>(
        ...
        ($core.List<$core.int> value) => $0.Empty.fromBuffer(value),
        ($0.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SubmitEmailRequest, $0.SubmitEmailResponse>(
        'SubmitEmail',
        submitEmail_Pre,
        false,
        false,
  ...
  $async.Future<$0.SubmitEmailResponse> submitEmail_Pre($grpc.ServiceCall call, $async.Future<$0.SubmitEmailRequest> request) async {
